...
import com.heshi.niuniu.im.contact.ContactCacheUpdateListenerImpl;
import com.heshi.niuniu.im.contact.ContactOperateNotifyListenerImpl;
                    ...
                    if (messageBody.getTransparentFlag() == 1) {
                        ...
                        try {
                            ...
                            if (object.has("text")) {
                                ...
                                Notification.showToastMsgLong(MyApplication.application, "透传消息，content = " + text);
